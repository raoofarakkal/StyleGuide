<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcCategoryTypeList.ascx.cs" Inherits="StyleGuideUI.UC.UcCategoryTypeList" %>
<script type="text/javascript">
    function UCTL_markUpdated(targetObjectName) {
        ...
        <td align="center">
            <div  style="width:350px;">
                <div style="text-align:left;">
                    <h1 style="padding:0px;margin:0px;">Category Types</h1>
                </div>
                <div id="divGv" style="font-weight: normal; border-top: 1px solid #c3cecc;border-bottom: 1px solid #c3cecc;width:350px;">
                    <asp:GridView ID="gvCatTypeList" runat="server" BorderColor="#c3cecc" CellPadding="5"
                        GridLines="Vertical" AutoGenerateColumns="False" BorderStyle="None"
                        BorderWidth="3px" OnRowCommand="gvCatTypeList_RowCommand" OnRowDataBound="gvCatTypeList_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Category Type" ItemStyle-Width="268px"  HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                ...
                <div style="padding-top: 10px;">
                    <table cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%;">
                        <tr>
                            <td align="left">
                                <asp:Button ID="btSave" CssClass="Button" runat="server" Text="Save" Width="100px"  UseSubmitBehavior="false" OnClick="btSave_Click" />
                            </td>
                            <td align="right">
                                <asp:Button ID="btNew" CssClass="Button" runat="server" Text="Add New Type" Width="160px" UseSubmitBehavior="false" OnClick="btNew_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
